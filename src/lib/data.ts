...
export const portfolio = [
  {
    id: 1,
    title: 'Luxury Villa Basement Waterproofing',
    category: 'Residential',
    image: 'https://picsum.photos/800/450?random=1',
    hint: 'basement concrete',
    tags: ['Waterproofing', 'Residential'],
    description: 'Complete basement waterproofing system including exterior membrane, interior drainage, and humidity control for a 5,000 sq ft luxury villa.',
    ...
    results: '100% moisture elimination, improved indoor air quality',
  },
  {
    id: 2,
    title: 'Manufacturing Facility Insulation',
    category: 'Commercial',
    image: 'https://picsum.photos/800/450?random=2',
    hint: 'factory roof insulation',
    tags: ['Insulation', 'Commercial'],
    description: 'Large-scale spray foam insulation project for 50,000 sq ft manufacturing facility, improving energy efficiency by 45%.',
    location: 'Sharjah Industrial City',
    date: 'October 2024',
    ...
    results: '45% energy cost reduction, improved climate control',
  },
    {
    id: 3,
    ...
    description: 'Upgraded attic insulation from R-19 to R-49 using blown-in fiberglass, significantly improving home comfort and energy savings.',
    location: 'Springfield, IL',
    date: 'September 2024',
    client: 'The Miller Family',
    features: [
        'Blown-in fiberglass insulation',
        'Air sealing of attic penetrations',
        'Proper ventilation installation',
        'Energy Star certification',
    ],
    results: '30% reduction in heating/cooling costs, eliminated drafts',
  },
  {
    id: 4,
    title: 'New Office Building Envelope',
    category: 'Commercial',
    image: 'https://picsum.photos/800/450?random=4',
    hint: 'office building construction',
    tags: ['Insulation', 'Commercial'],
    description: 'Provided a complete thermal envelope solution for a new 5-story office building, including continuous exterior insulation and air barrier.',
    ...
    results: 'Exceeded local energy code requirements by 25%',
  },
  {
    id: 5,
    ...
    hint: 'crawl space encapsulation',
    tags: ['Waterproofing', 'Residential'],
    description: 'Transformed a damp, moldy crawl space into a clean, dry area by installing a vapor barrier and dehumidification system.',
    location: 'Oakville, IL',
    date: 'July 2024',
    client: 'The Johnson Family',
    features: [
        '20-mil vapor barrier on floor and walls',
        'Sealed seams and penetrations',
        'Installed a high-efficiency dehumidifier',
        'Mold remediation pre-treatment',
    ],
    results: 'Eliminated musty odors, reduced indoor humidity from 75% to 45%',
  },
  {
    id: 6,
    ...
    hint: 'industrial pipes',
    tags: ['Insulation', 'Industrial'],
    description: 'Insulated over 2,000 feet of high-temperature process piping in a manufacturing plant to improve safety and thermal efficiency.',
    location: 'Industry Park, IL',
    date: 'June 2024',
    client: 'ChemPro Industries',
    features: [
        'Custom-fabricated mineral wool insulation',
        'Durable aluminum jacketing',
        'Personnel protection from hot surfaces',
        'Color-coded identification labels',
    ],
    results: 'Reduced surface temperatures by 200°F, saving an estimated $50,000 annually in energy loss',
  },
];
